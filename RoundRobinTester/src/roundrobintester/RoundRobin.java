...
public class RoundRobin {
   int [] temp;
    ...
    //initializes recursive loop to iterate through  time stamps until burst time has been completed
    void start( ){
...
private void display(List<Job> jobList) {
        ...
        int c = 1;
        System.out.println("======================================================== ");
        System.out.println("Process ID | Turnaround time | Waiting time | Switches");
        System.out.println("======================================================== ");
        Object[] job = jobList.toArray();
        for (int i : temp) {
            Job job1 = (Job) job[c-1];
            System.out.println( "    " + c + "       |     " + i +"           |   "+(i-job1.getCpuTime())+ "     |      "+switches+ "     |     ");
            System.out.println("----------------------------------------");
