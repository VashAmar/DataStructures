...
*/
public class VASelectionSorter
{
   ...
   /**
      ...
      pauses
   */
   public VASelectionSorter(int[] anArray, JComponent aComponent)
   {
      a = anArray;
   ...
   public void draw(Graphics g)
   {
      ...
      try
      {
         ...
         for (int i = 0; i < a.length; i++)
         {
           ...
           Graphics2D g2 = (Graphics2D) g;  //cast g as 2d graphic so that you can set stroke to a thicker line width
            g2.setStroke(new BasicStroke(3));
    
            g2.drawLine(i * deltaX, 0, i * deltaX, a[i]);
         }
      }
      finally
      {
